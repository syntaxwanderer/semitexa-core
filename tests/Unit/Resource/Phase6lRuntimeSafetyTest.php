 ...
 *     runtime classes; they are pure value objects + codec.
...
final class Phase6lRuntimeSafetyTest extends TestCase
{
    ...
    #[Test]
    public function collection_cursor_source_is_pure(): void
    {
        $this->assertSourcePure(
            __DIR__ . '/../../../src/Resource/Cursor/CollectionCursor.php',
            self::CURSOR_FORBIDDEN,
        );
    }

    #[Test]
    public function collection_cursor_codec_source_is_pure(): void
    {
        $this->assertSourcePure(
            __DIR__ . '/../../../src/Resource/Cursor/CollectionCursorCodec.php',
            self::CURSOR_FORBIDDEN,
        );
    }

    #[Test]
    public function collection_cursor_page_source_is_pure(): void
    {
        $this->assertSourcePure(
            __DIR__ . '/../../../src/Resource/Cursor/CollectionCursorPage.php',
            self::CURSOR_FORBIDDEN,
        );
    }
